...
export const BRANDS: Record<string, Brand> = {
  ...
  "mercedes-benz": {
    ...
    hero: {
      ...
      media: {
        kind: "video",
        src: "/src/assets/heroVids/mbVid.webm",
        poster: "src/assets/posters/mbPoster.webp",
        autoPlay: true,
        loop: true,
        muted: true,
      },
    ...
    gallery: {
      ...
      rowPattern:   [2, 2, 2, 2],
      items: [
        { src: "/src/assets/gallery/mbCard4.webp", alt: "EQS SUV headlights close-up",
          caption: "Striking EQS SUV design feature: new radiator trim with chrome applications and upright star." },
        { src: "/src/assets/gallery/mbCard1.webp", alt: "EQS interior with Hyperscreen",
          caption: "Red gold elements in the interior hint at the electric character." },
        { src: "/src/assets/gallery/mbCard2.webp", alt: "LED light strip at rear",
          caption: "LED light strip at front and rear for high recognition by day and night." },
        { src: "/src/assets/gallery/mbCard3.webp", alt: "Aero wheel close-up",
    ...
    banner: {
      ...
      bgImage: "/src/assets/banner/mb.webp",
      bgSize: "cover",
    },
    ...
    benefits: {
      ...
      items: [
        {
          image: "/src/assets/benefits/mb-1.jpg",
        ...
        {
          image: "/src/assets/benefits/mb-2.webp",
        ...
        {
          image: "/src/assets/benefits/mb-3.avif",
          ...
          // linkHref: "/brand/mercedes-benz/charging"
        }
      ]
    },
  ...
  tesla: {
    ...
    hero: {
      ...
      media: { kind: "image", src: "/src/assets/heroVids/posters/teslaPoster.png", alt: "Tesla Model 3" },
      ctas: [
    ...
    gallery: {
      ...
      rowPattern:   [2, 2, 2, 2],
      items: [
        { src: "/src/assets/gallery/tsCard1.webp", alt: "Tesla LED headlights close-up",
          caption: "Sharper LED headlights and a sculpted front fascia." },
        { src: "/src/assets/gallery/tsCard2.webp", alt: "Tesla interior with central touchscreen",
          caption: "Minimalist cabin with a large central touchscreen." },
        { src: "/src/assets/gallery/tsCard3.webp", alt: "Tesla rear three-quarter view",
          caption: "Continuous light signature and aero-optimized silhouette." },
        { src: "/src/assets/gallery/tsCard4.webp", alt: "Tesla aero wheels close-up",
    ...
    banner: {
      ...
      bgImage: "/src/assets/banner/tesla.png",
      bgSize: "cover",
    },
    ...
    benefits: {
      ...
      items: [
        {
          image: "/src/assets/benefits/tesla-1.avif",
        ...
        {
          image: "/src/assets/benefits/tesla-2.webp",
        ...
        {
          image: "/src/assets/benefits/tesla-3.avif",
          ...
          // linkLabel: "Home charging guide",
          // linkHref: "/brand/tesla/charging"
        }
      ]
    },
  ...
  bmw: {
    ...
    hero: {
      ...
      media: {
        kind: "video",
        src: "/src/assets/heroVids/bmwVid.webm",
        poster: "src/assets/posters/mboster.webp",
        autoPlay: true,
        loop: true,
        muted: true,
      },
    ...
    gallery: {
      ...
      rowPattern:   [2, 2, 2, 2],
      items: [
        { src: "/src/assets/gallery/bmwCard3.jpg", alt: "BMW illuminated grille and headlights",
          caption: "Striking front with illuminated contour and precise LED headlights." },
        { src: "/src/assets/gallery/bmwCard1.jpg", alt: "BMW i5 interior with Curved Display",
          caption: "Curved Display and an interaction light bar across the dashboard." },
        { src: "/src/assets/gallery/bmwCard4.jpg", alt: "BMW i5 rear three-quarter view",
          caption: "Slim L-shaped taillights and a dynamic roofline." },
        { src: "/src/assets/gallery/bmwCard2.webp", alt: "BMW aerodynamic wheel close-up",
    ...
    banner: {
      ...
      ctaHref: "/evs/bmw-i4",
      bgImage: "/src/assets/banner/bmw.webp",
      bgSize: "cover",
    },
    ...
    benefits: {
      ...
      items: [
        {
          image: "/src/assets/benefits/bmw-1.jpg",
  ...
  hero: {
    ...
    media: {
      kind: "image",
      src: "/src/assets/heroVids/posters/audiPoster.avif",
  ...
  gallery: {
    ...
    items: [
      {
        src: "/src/assets/gallery/audiCard1.webp",
        alt: "Audi Matrix LED close-up",
        caption: "Matrix LED lighting signature with dynamic turn indicators."
      },
      {
        src: "/src/assets/gallery/audiCard2.avif",
        alt: "Audi Virtual Cockpit interior",
        caption: "Virtual Cockpit and MMI touch response with haptic feedback."
      },
      {
        src: "/src/assets/gallery/audiCard3.webp",
        alt: "Audi rear light bar",
        caption: "Continuous rear light bar emphasizes width and stance."
      },
      {
        src: "/src/assets/gallery/audiCard4.jpg",
        alt: "Aero wheel close-up",
  ...
  banner: {
    ...
    bgImage: "/src/assets/banner/audi.avif",
    bgSize: "cover",
  },
  ...
  benefits: {
    ...
    items: [
      {
        image: "/src/assets/benefits/audi-1.avif",
